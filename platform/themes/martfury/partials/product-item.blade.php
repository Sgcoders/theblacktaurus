@if ($product)
    <div>
        ...
        {{--                       data-url="{{ route('public.cart.add-to-cart') }}"><i class="fas fa-shopping-cart"></i>{{ __('Add To Cart') }}</button>--}}
    </div>
    ...
    {{--            <li><a class="js-add-to-wishlist-button" href="#"--}}
    {{--                   data-url="{{ route('public.wishlist.add', $product->id) }}" title="{{ __('Add to Wishlist') }}"><i--}}
