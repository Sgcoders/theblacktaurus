    ...
    value: function init() {
      ...
      var loadShippingFeeAtTheFirstTime = function loadShippingFeeAtTheFirstTime() {
        ...
        if (shippingMethod.length) {
          ...
          var _isAddressAvailable = $('.customer-address-payment-form #address_id option:selected').val();

          if (!_isAddressAvailable) {
            var _addressForm = $('.customer-address-payment-form').clone();
          }
      ...
      var loadShippingFeeAtTheSecondTime = function loadShippingFeeAtTheSecondTime() {
        ...
        if (!isAddressAvailable) {
          var _addressForm2 = $('.customer-address-payment-form').clone();
        }
